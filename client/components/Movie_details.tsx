            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-3">
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center space-x-2 text-gray-400 text-lg">
                        ...
                        <p className='capitalized text-lg'>Released Year</p>
                    </div>
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center space-x-2 text-gray-400 text-lg">
                        ...
                        <p className='capitalized text-lg'>Available languages</p>
                    </div>
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center space-x-2 text-gray-400 text-lg">
                        ...
                        <p className='capitalized text-lg'>Genres</p>
                    </div>
                ...
                <div className="flex flex-col space-y-3">
                    <div className="flex items-center space-x-2 text-gray-400 text-lg">
                        ...
                        <p className='capitalized text-lg'>Popularity</p>
                    </div>
